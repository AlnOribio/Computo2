...
<body>
    <div class="formulario formulario_m">
        ...
        <h1 class="h1 h1_m">Registros</h1>
        <fieldset class="fieldset fieldset_m">
            <fieldset class="fieldset_input">
            <table class="tabla_m" border="5">
  <tr bgcolor="#1B1C30" style="color:#FF6";><td>No. Cuenta</td><td>Nombre</td><td>Semestre</td><td>Eliminar</td></tr>
<?php
...
?> 
  <tr bgcolor="#D8DFD0" onmouseover="this.style.background='#FFD961';" onmouseout="this.style.background='#D8DFD0';">
     ...
     <td> <a href="eliminacion_alumnos.php?idalumno=<?php echo $lafila['nocta']; ?>" style="color:#ff0000";>Eliminar</a> </td>
  </tr>
<?php
   }//fin del while
 }
?>
    ...
    <div class="formulario2 formulario2_m">
        <fieldset class="fieldset2 fieldset2_m">
            <fieldset class="fieldset_input">
            <table class="tabla_m" border="5">
  <tr bgcolor="#1B1C30" style="color:#FF6";><td>No. Material</td><td>Material</td><td>Cantidad</td><td>Descripcion</td><td>Eliminar</td></tr>
<?php
   include "conexion.php";
...
?> 
  <tr bgcolor="#D8DFD0" onmouseover="this.style.background='#FFD961';" onmouseout="this.style.background='#D8DFD0';">
     ...
     <td> <a href="eliminacion_material.php?idmaterial=<?php echo $lafila['mocta']; ?>" style="color:#ff0000";>Eliminar</a> </td>
  </tr>
<?php
   }//fin del while
 }
