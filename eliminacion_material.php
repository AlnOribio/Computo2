...
<body class="body">
    <div class="inicio centered-container">
        ...
        <div class="tabla_inicio">
            ...
            <div class="seleccion">
                <?php
                $valornumeroc = $_GET['idmaterial'];
                include "conexion.php";
                $myconsulta = "delete from material where mocta=" . $valornumeroc;
                $conectar->query($myconsulta);
                $conectar->close();
                echo "Se ha eliminado el registro:<br> Número de Material: " . $valornumeroc . "<br><br>";
